...
@section('main-section')
    ...
    <section class="apply">
        <h2>Apply Here</h2>
        <p>Register your child with us at Blue Horizon. To enroll your child at Blue Horizon, kindly fill in the required information on this page. Fill in all details regarding Student Name, Parents/guardians on the form in order to complete the registration process.</p>
