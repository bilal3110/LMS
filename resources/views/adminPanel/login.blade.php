    ...
    <section class="d-flex justify-content-center align-items-center py-5"
        ...
        <div class="card p-5" style="width: 30rem">
          ...
          "
            ...
            <form action="{{ route('login') }}" id="apply-form" class="d-flex flex-column" method="POST">
              @csrf
                <div class="mb-3">
                ...
                <span class="text-center my-2">
                    <h4 style="font-size:16px;font-weight:600">Don't Have an Account! <a
                            href="{{ route('adminSignup') }}">Sign Up</a></h4>
                </span>
            </form>
            @if ($errors->any())
